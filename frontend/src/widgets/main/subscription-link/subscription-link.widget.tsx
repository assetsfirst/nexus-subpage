import { IconBrandDiscord, IconBrandTelegram, IconBrandVk, IconLink, IconMessageChatbot } from '@tabler/icons-react'
...
export const SubscriptionLinkWidget = ({ supportUrl }: { supportUrl?: string }) => {
    ...
    return (
        <Group gap="xs">
            <Tooltip label={t('subscription-link.widget.get-link')}>
                <ActionIcon
                    onClick={() => {
